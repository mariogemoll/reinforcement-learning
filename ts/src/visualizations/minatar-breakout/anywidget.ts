...
import { initMinAtarBreakoutVisualization } from './index';
...
async function render({
  ...
  parent.id = 'minatar-breakout-visualization';
  ...
  const mount = async(): Promise<void> => {
    ...
    const created = await Promise.resolve(initMinAtarBreakoutVisualization(parent, weightsUrl));
