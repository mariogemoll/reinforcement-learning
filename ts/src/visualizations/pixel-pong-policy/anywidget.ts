...
import { initPixelPongPolicyVisualization } from './index';
...
async function render({
  ...
  parent.id = 'pixel-pong-policy-visualization';
  ...
  const mount = async(): Promise<void> => {
    ...
    const created = await initPixelPongPolicyVisualization(parent, weightsUrl);
