...
import type { PixelPongPolicyVizDom, QBarEls } from './types';
...
export function createPixelPongPolicyVizDom(): PixelPongPolicyVizDom {
  const container = document.createElement('div');
  container.className = 'visualization pixel-pong-policy-viz-container';
